            ...
            <div className="wrapper max-w-7xl mx-auto px-6 pt-24 pb-12 relative z-10 flex flex-col gap-24">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 lg:gap-8">
                    ...
                    <div className="footer-reveal flex flex-col gap-8">
                        <Link href="/" scroll={false} className="flex items-center gap-2 w-fit">
                            <Image
                        ...
                        <div className="flex gap-4">
                            <Link href="#" scroll={false} className="p-3 rounded-full bg-white/5 hover:bg-accent-blue/20 transition-colors group">
                    ...
                    <div className="footer-reveal flex flex-col gap-8">
                        ...
                        <nav className="flex flex-col gap-4">
                            <Link href="/" scroll={false} className="text-body-normal text-white/60 hover:text-white transition-colors w-fit">About</Link>
                            <Link href="#" scroll={false} className="text-body-normal text-white/60 hover:text-white transition-colors w-fit">Strategy</Link>
                            <Link href="#" scroll={false} className="text-body-normal text-white/60 hover:text-white transition-colors w-fit">Our Work</Link>
                            <Link href="/contact" scroll={false} className="text-body-normal text-white/60 hover:text-white transition-colors w-fit">Contact</Link>
                        </nav>
                    </div>
                    ...
                    <div className="footer-reveal flex flex-col gap-8">
                        ...
                        <nav className="flex flex-col gap-4">
                            {['Digital Media', 'Transit & OOH', 'Emerging Platforms', 'Data Analytics'].map((item) => (
                                <Link key={item} href="#" scroll={false} className="text-body-normal text-white/60 hover:text-white transition-colors w-fit">
                                    {item}
                                </Link>
                            ))}
                        </nav>
                ...
                <div className="footer-reveal flex flex-col md:flex-row justify-between items-center gap-8 border-t border-white/5 pt-12">
                    ...
                    <div className="flex flex-wrap justify-center gap-8 text-sm text-white/40">
                        <Link href="#" scroll={false} className="hover:text-white transition-colors">Privacy Policy</Link>
                        <Link href="#" scroll={false} className="hover:text-white transition-colors">Terms of Service</Link>
                        <Link href="#" scroll={false} className="hover:text-white transition-colors">Cookie Policy</Link>
                    </div>
                </div>
