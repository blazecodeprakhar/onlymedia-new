                    ...
                    <div className="top">
                        <div className="card-top-1">
                            ...
                            <p className="text-body-large">
                                <span className="font-semibold">Personalize every detail</span>, From branding and interface layout to colors and menus, so OnlyMedia feels like an extension of your brand.
                            </p>
                        </div>
                        ...
                        <div className="card-top-2">
                            ...
                            <p className="text-body-large">
                                <span className="font-semibold">Seamless integrations</span>. Plug OnlyMedia into the tools you love. Set up automations, sync your data, and make your systems work smarter together.
                            </p>
                        </div>
                    </div>
